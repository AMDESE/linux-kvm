...
enum sev_cmd {
	...
	SEV_CMD_TIO_INIT		= 0xD1,
	SEV_CMD_TIO_DEV_CREATE		= 0xD2,
	SEV_CMD_TIO_DEV_RECLAIM		= 0xD3,
	SEV_CMD_TIO_DEV_CONNECT		= 0xD4,
	SEV_CMD_TIO_DEV_DISCONNECT	= 0xD5,
	SEV_CMD_TIO_DEV_STATUS		= 0xD6,
